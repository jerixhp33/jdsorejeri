...
export function PremiumInvoiceLayout({ order }: PremiumInvoiceLayoutProps) {
  return (
    <div 
      id="invoice-content"
      className="print-receipt-container bg-white w-full max-w-[210mm] mx-auto min-h-[297mm] shadow-[0_0_40px_rgba(0,0,0,0.1)] p-10 sm:p-12 flex flex-col relative font-sans text-black print:shadow-none print:w-[210mm] print:h-[297mm] print:overflow-hidden print:p-8"
    >
