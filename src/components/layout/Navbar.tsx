...
export function Navbar({ categories = [], hasBanner = false }: NavbarProps) {
  ...
  return (
    <>
      <div className={cn(
        ...
        scrolled ? (hasBanner ? "top-[110px] sm:top-[60px]" : "top-2 sm:top-4") : (hasBanner ? "top-[110px] sm:top-[60px]" : "top-2 sm:top-4")
      )}>
        <header
          className={cn(
