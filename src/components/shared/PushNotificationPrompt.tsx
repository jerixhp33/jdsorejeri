      ...
      >
        ...
        <div className="flex gap-3 mt-5">
          ...
          <button
            ...
            disabled={isSubscribing}
            className="flex-1 px-4 py-2.5 rounded-xl bg-white hover:bg-foreground/ text-black text-xs font-bold transition-all shadow-lg shadow-white/5 flex items-center justify-center disabled:opacity-50"
          >
