    ...
    <div className="space-y-6">
              ...
              >
                <div className="relative aspect-video bg-card">
                  <div className="absolute top-2 right-2 z-10">
                    <button onClick={(e) => { e.stopPropagation(); toggleSelection(product.id); }} className={cn("w-6 h-6 rounded flex items-center justify-center transition-all", selectedIds.includes(product.id) ? "bg-luxe-accent text-black" : "bg-black/50 text-foreground/ border border-foreground/ hover:border-foreground/")}>
                ...
                <div className="p-4">
                  ...
                  <h3 className="text-foreground text-sm font-medium mb-2 line-clamp-2">{product.name}</h3>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg bg-foreground/ text-foreground/ hover:bg-foreground/ hover:text-foreground transition-all"
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        product.is_featured ? 'bg-luxe-accent/20 text-luxe-accent' : 'bg-foreground/ text-foreground/ hover:bg-foreground/'
                      )}
                    ...
                    <button
                      ...
                      className="p-2 rounded-lg bg-foreground/ text-foreground/ hover:bg-red-500/20 hover:text-red-400 transition-all"
                    >
      ...
      {selectedIds.length > 0 && (
        <motion.div initial={{ y: 100 }} animate={{ y: 0 }} className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 glass-card px-6 py-4 rounded-full flex items-center gap-6 shadow-2xl border-luxe-accent/30">
          <span className="text-foreground font-medium">{selectedIds.length} selected</span>
          <div className="flex items-center gap-3">
            <button onClick={() => setSelectedIds([])} className="text-foreground/ hover:text-foreground text-sm transition-colors">Cancel</button>
            <button onClick={bulkDelete} className="bg-red-500/20 text-red-400 hover:bg-red-500 hover:text-foreground px-4 py-2 rounded-full text-sm font-medium transition-all flex items-center gap-2">
