    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
        ...
        <tr><td style="background:#1a1a1a;padding:32px 40px;text-align:center;">
          <p style="margin:0;font-family:Georgia,serif;font-size:22px;font-weight:bold;color:#c8a96e;letter-spacing:3px;">LUXE STORE</p>
        </td></tr>
        <!-- Body -->
        <tr><td style="padding:40px;">
          ...
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr><td style="background:#c8a96e;border-radius:50px;">
              <a href="https://luxestore.in" style="display:inline-block;padding:14px 32px;font-size:14px;font-weight:bold;color:#000000;text-decoration:none;font-family:Arial,sans-serif;letter-spacing:1px;">Shop New Arrivals</a>
            </td></tr>
          </table>
        </td></tr>
        <!-- Footer -->
    ...
    <tr><td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
        ...
        <tr><td style="padding:40px;">
          ...
          <table role="presentation" cellpadding="0" cellspacing="0">
            <tr><td style="background:#c8a96e;border-radius:50px;">
              <a href="https://luxestore.in" style="display:inline-block;padding:14px 32px;font-size:14px;font-weight:bold;color:#000000;text-decoration:none;font-family:Arial,sans-serif;letter-spacing:1px;">Grab the Deal</a>
            </td></tr>
          </table>
