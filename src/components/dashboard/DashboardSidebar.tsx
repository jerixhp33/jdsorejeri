...
export function DashboardSidebar() {
  ...
  return (
    <>
      ...
      <div className="mobile-bottom-nav-container md:hidden print:hidden fixed bottom-6 left-0 right-0 z-[120] flex justify-center pointer-events-none transition-all duration-300">
