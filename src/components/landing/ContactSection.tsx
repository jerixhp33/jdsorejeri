        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <motion.p
              ...
              className="text-foreground/ text-base leading-relaxed mb-10"
            >
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <div>
                  <p className="text-foreground font-medium text-sm mb-0.5">WhatsApp</p>
                  <a
                    href="https://wa.me/919360490974"
                    rel="noopener noreferrer"
                    className="text-foreground/ text-sm hover:text-luxe-accent transition-colors"
                  >
                    +91 9360490974
                  </a>
                </div>
              ...
              >
                ...
                <div>
                  <p className="text-foreground font-medium text-sm mb-0.5">Email</p>
                  <a
              ...
              >
                ...
                <div>
                  <p className="text-foreground font-medium text-sm mb-0.5">Location</p>
              ...
              >
                ...
                <div>
                  <p className="text-foreground font-medium text-sm mb-0.5">Hours</p>
                  <p className="text-foreground/ text-sm">Mon–Sat, 9 AM – 7 PM IST</p>
                </div>
              </motion.div>
            </div>
          </div>
          ...
          >
            ...
            <a
              ...
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-green-500 text-foreground font-semibold px-8 py-3.5 rounded-full hover:bg-green-400 transition-colors w-full justify-center"
            >
              <MessageCircle className="w-4 h-4" />
              Start a Conversation
            </a>
            <p className="text-foreground/ text-xs mt-4">Usually replies in under 30 minutes</p>
          </motion.div>
        </div>
      </div>
    </section>
