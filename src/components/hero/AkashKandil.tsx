...
export function AkashKandil({ className = "w-full h-full" }: { className?: string }) {
  return (
    <motion.svg 
      viewBox="0 0 160 300" 
      fill="none" 
    ...
    >
      <defs>
        {/* Lantern Core Glow */}
        <radialGradient id="kandilGlow" cx="80" cy="110" r="70" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#FBBF24" stopOpacity="0.9" />
          <stop offset="50%" stopColor="#F59E0B" stopOpacity="0.6" />
          <stop offset="100%" stopColor="#D97706" stopOpacity="0" />
        </radialGradient>

        <linearGradient id="kandilGold" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#FBBF24" />
          <stop offset="50%" stopColor="#F59E0B" />
          <stop offset="100%" stopColor="#B45309" />
        </linearGradient>

        <linearGradient id="kandilCrimson" x1="0" y1="0" x2="1" y2="1">
      ...
      {/* Ambient Core Glow */}
      <circle cx="80" cy="110" r="55" fill="url(#kandilGlow)" />
      ...
      {/* Outer Diamond */}
      <polygon points="80,50 125,110 80,170 35,110" fill="url(#kandilCrimson)" stroke="#FBBF24" strokeWidth="2" />
      {/* Inner Facets */}
      <polygon points="80,50 102,110 80,170 58,110" fill="url(#kandilGold)" opacity="0.9" stroke="#FDE68A" strokeWidth="1" />
      ...
      <motion.g
        ...
        style={{ transformOrigin: '80px 170px' }}
      >
        {/* Tassel Strands */}
