...
export const FESTIVAL_THEMES: Record<FestivalType, FestivalTheme> = {
  diwali: {
    ...
    marqueeClasses: 'bg-amber-900/40 border-amber-500/20 text-amber-100 shadow-[0_10px_30px_rgba(245,158,11,0.08)]',
  ...
  vinayagar_chaturthi: {
    gradientFrom: '#0d1a0a',
    gradientVia: '#1a2e12',
    radialGlow: 'rgba(249, 115, 22, 0.12)',
    navbarScrolledClasses: 'bg-[#1a120a]/70 backdrop-blur-2xl border border-orange-500/20 shadow-[0_8px_32px_rgba(249,115,22,0.15)] hover:bg-[#1a120a]/80 hover:border-orange-500/30',
    navbarUnscrolledClasses: 'bg-[#1a120a]/50 backdrop-blur-md border border-orange-500/10 shadow-[0_4px_20px_rgba(249,115,22,0.1)] hover:bg-[#1a120a]/60 hover:border-orange-500/20',
    marqueeClasses: 'bg-orange-900/40 border-orange-500/20 text-orange-100 shadow-[0_10px_30px_rgba(249,115,22,0.08)]',
    marqueeText: 'text-orange-100/90',
