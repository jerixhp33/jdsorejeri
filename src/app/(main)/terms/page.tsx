  ...
  return (
    <div className="page-container py-24 md:py-32 max-w-4xl">
      ...
      <div className="space-y-8 text-foreground/ leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-4">2. Orders and Payment</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-4">3. Shipping and Delivery</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-4">4. Returns and Refunds</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-foreground mb-4">5. Modifications to Service</h2>
          <p>
