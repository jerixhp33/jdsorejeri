  ...
  return (
    <div className="page-container pt-20 sm:pt-24 pb-12 md:pb-20">
      ...
      <div className="max-w-3xl mb-12 md:mb-20">
        ...
        <h1 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-12 md:mb-20">
        <div id="shipping" className="glass-card p-5 md:p-6">
          ...
          <h2 className="text-white font-semibold text-base md:text-lg mb-2 md:mb-3">Shipping Policy</h2>
          <div className="space-y-2 md:space-y-3 text-white/55 text-sm leading-relaxed">
        ...
        <div id="returns" className="glass-card p-5 md:p-6">
          ...
          <h2 className="text-white font-semibold text-base md:text-lg mb-2 md:mb-3">Return Policy</h2>
          <div className="space-y-2 md:space-y-3 text-white/55 text-sm leading-relaxed">
        ...
        <div id="privacy" className="glass-card p-5 md:p-6">
          ...
          <h2 className="text-white font-semibold text-base md:text-lg mb-2 md:mb-3">Privacy Policy</h2>
          <div className="space-y-2 md:space-y-3 text-white/55 text-sm leading-relaxed">
        ...
        <div id="terms" className="glass-card p-5 md:p-6">
          ...
          <h2 className="text-white font-semibold text-base md:text-lg mb-2 md:mb-3">Terms of Service</h2>
          <div className="space-y-2 md:space-y-3 text-white/55 text-sm leading-relaxed">
